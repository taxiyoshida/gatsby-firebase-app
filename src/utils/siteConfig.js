module.exports = {
  ...
  siteTitleAlt: 'Tech-economics news', // This allows an alternative site title for SEO schema.
  publisher: 'axion technologies', // Organization name used for SEO schema
  siteDescription:
